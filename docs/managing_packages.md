Assuming you are working with the recommended function-based components only and one general base image, there are two ways for you to make python packages available in components.
